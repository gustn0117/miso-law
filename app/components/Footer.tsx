  ...
  return (
    <footer className="site-footer">
      <div className="container footer-inner">
        ...
        <div>
          <div className="footer-col-title">주요 카테고리</div>
          <ul className="footer-links">
            ...
            <li><Link href="/category/civil">민사 / 돈 문제</Link></li>
            <li><Link href="/category/recovery">회생 / 파산</Link></li>
            <li><Link href="/category/family">이혼 / 가사</Link></li>
            <li><Link href="/category/labor">노동 / 퇴직금</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="footer-links">
            ...
            <li><Link href="/cafe">네이버 카페</Link></li>
            <li><Link href="/shorts">쇼츠 보기</Link></li>
